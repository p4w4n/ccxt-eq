...
use ccxt\abstract\zerodha as Exchange;
...
class zerodha extends Exchange {
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        $response = $this->publicGetQuote ($this->extend($request, $params));
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateGetInstrumentsHistoricalInstrumentTokenInterval ($this->extend($request, $params));
    ...
    public function fetch_balance($params = array ()): array {
        ...
        list($marginResponse, $holdingsResponse) = Promise\all(array(
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): array {
        ...
        $response = $this->privatePostOrdersVariety ($this->extend($request, $omitted));
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $response = $this->privateDeleteOrdersVarietyOrderId ($this->extend($request, $omitted));
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->privateGetTrades ($params);
